- LATER 00:43 [[執行read修改tail後，cmd q會亂掉]]
...
- NOW 10:43 [[spi autoload]] #fail
  :LOGBOOK:
  CLOCK: [2023-04-10 Mon 10:52:27]
  :END:
...
- LATER 為什麼agates每個ch要配到128條cmd queue?而2312每個ch為什麼是32條cmd queue? #RKIT
